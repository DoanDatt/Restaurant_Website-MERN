...
const VerifyEmail = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen w-full">
      <div className="flex flex-col gap-10 p-8 rounded-md w-full max-w-md border border-gray-200">
        ...
        <form>
          ...
          {loading ? (
            <Button
              disabled
              className="bg-(--orange) hover:bg-(--hoverOrange) mt-6 w-full cursor-not-allowed"
            >
